...
extern uint32_t assemble_add_sub_instruction(char** tokens, uint32_t token_count);
extern uint32_t mov_wide_assembly(char** tokens, uint32_t token_count);

extern uint32_t cmp_assembly(char** tokens, uint32_t token_count);
extern uint32_t cmn_assembly(char** tokens, uint32_t token_count);
extern uint32_t neg_assembly(char** tokens, uint32_t token_count);
extern uint32_t negs_assembly(char** tokens, uint32_t token_count);
extern uint32_t tst_assembly(char** tokens, uint32_t token_count);
extern uint32_t mvn_assembly(char** tokens, uint32_t token_count);
extern uint32_t mov_assembly(char** tokens, uint32_t token_count);
extern uint32_t mul_assembly(char** tokens, uint32_t token_count);
extern uint32_t mneg_assembly(char** tokens, uint32_t token_count);

extern uint32_t get_logic_opcode(const char* mnemonic, uint32_t *N);
extern int get_add_sub_opcode(const char* mnemonic, uint8_t* op_out, uint8_t* S_out);
extern int get_mov_opcode(const char* mnemonic, uint8_t* opc_out);
